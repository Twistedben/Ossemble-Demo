class PoliceScore < ApplicationRecord
...
# Begin - ASSOCIATIONS: Many/Belongs To/One Relations.   
  # Below - Sets up One to One relationship between PoliceScore and the city_score table (city_score has_one police_score)
  belongs_to :city_score
  # Below - Sets up One to One relationship between PoliceScore and the cities table (city has_one police_score through city_score)
