class GovernmentScore < ApplicationRecord
# One of Five Category Tables for Departments' and Complaints. Tallies up the Governmental buildings avg score for a city and stores their score as a factor of .25.

# Begin - Gems and acts_as setups. 
  # Below - PAPERTRAIL: Allows versioning for GovernmentScore so if implemented, trending score can be used.
    has_paper_trail
...
# Begin - ASSOCIATIONS: Many/Belongs To/One Relations for GovernmentScore.   
  # Below - Sets up One to One relationship between GovernmentScore and the city_score table (city_score has_one government_score)
  belongs_to :city_score
  # Below - Sets up One to One relationship between GovernmentScore and the cities table (city has_one government_score through city_score)
...
# End - ASSOCIATIONS: Many/Belongs To/One Relations for GovernmentScore.   
...
# Begin - CUSTOM CALLBACKS: Before_save, after_commit, & Callbacks for GovernmentScore Model.
  ...
  def update_government_avg_score
  ...
  # Below - Turns the factored Government Score into a whole score out of 100.  
