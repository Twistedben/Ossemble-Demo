class MapPostCategory < ApplicationRecord
# Main Model for Workplace Shape Categories that hold a name and foreign key for WorkplaceMapShape.
...
# Begin - ASSOCIATIONS: Many/Belongs To/One Relations.   
  # Below - Associates Shapes Categories as a one to one relationship with Workplace Map Posts. (WorkplaceMapPost has many categories)  
  has_many :map_posts, class_name: "WorkplaceMapPost", foreign_key: "map_post_category_id"
